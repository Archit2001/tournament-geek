            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="nav navbar-nav ml-auto">
                <li class="nav-item active">
                  ...
                  <div style="position:absolute; transform: translate(-50%, -50%); top: 50%; left: 50%; font-size: 40px;">
              <ul class="nav justify-content-center">
               <a href="index.php"> <li>Tournament Geek</li></a>
              </ul>
            </div>
                    <li class="nav-item active mr-2">
                  <a href= login.php><button type="submit" class="btn btn-primary mb-2">Login</button></a>
                </li>
                <li class="nav-item active mr-2">
          ...
          <div class="row">
            ...
            <div class="col-sm-4 col-md-4 col-lg-4">
              <div class="card" style="width: 18rem;">
                <div class="thumbnail">
                  <a href="log.php"><img class="card-img-top" src="images/Foot.jpg" alt="Card image cap">
                </div>
                <div class="card-body">
            ...
            <div class="col-sm-4 col-md-4 col-lg-4">
              <div class="card" style="width: 18rem;">
                <div class="thumbnail">
                 <a href="log.php"><img class="card-img-top" src="images/lee.jpg" alt="Card image cap">
                </div>
                <div class="card-body">
            ...
            <div class="col-sm-4 col-md-4 col-lg-4">
              <div class="card" style="width: 18rem;">
                <div class="thumbnail">
                  <a href="log.php"><img class="card-img-top" src="images/cric.jpg" alt="Card image cap">
                </div>
                <div class="card-body">
