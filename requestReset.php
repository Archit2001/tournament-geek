...
if (isset($_POST["email"])) {
   ...
   $query= mysqli_query($con , "INSERT INTO code(email,code) VALUES ('$emailTo','$code')");
...
try {
    ...
    $mail->SMTPAuth   = true;                              
    $mail->Username   = 'archit200130@gmail.com';                   
    $mail->Password   = 'odtxqummazktrziq';                               
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         
    $mail->Port       = 587;                                  

    //Recipients
    $mail->setFrom('Tournament@gmail.com', 'Tournament Geek');
    $mail->addAddress($emailTo);     
    $mail->addReplyTo('archit200130@gmail.com', 'no-reply');
   
    
    $url =  "http://localhost/userregistration/resetpassword.php?code=$code";
    $mail->isHTML(true);                                 
    $mail->Subject =  '';
    $mail->Body    = "<b>Tournament Geek Is Sharing You The Password Reset Link</b> <p>please do not share it with anyone else</p><h1> Your Requested Password Reset Link is given below </h1><br> click <a href='$url'> here  to reset your password";
    ...
    echo "message could not be send",$email->Errorinfo;
  }
  exit();
}
?>
                  ...
                  <tr>
                    <td class="inner contents center" style="padding-top:15px;padding-bottom:15px;padding-right:30px;padding-left:30px;text-align:left;">
                      <center>
                        ...
                        <p class="description center" style="font-family:'Muli','Arial Narrow',Arial;Margin:0;text-align:center;max-width:320px;color:#a1a8ad;line-height:24px;font-size:15px;Margin-bottom:10px;margin-left: auto; margin-right: auto;"><span style="color: rgb(161, 168, 173); font-family: Muli, &quot;Arial Narrow&quot;, Arial; font-size: 15px; text-align: center; background-color: rgb(255, 255, 255);">That's okay, it happens! Write Your Email below to reset your password.</span>
                         <form method="POST"  style="border-width: 0px; margin-top: 30px; margin-bottom: 50px; width: 260px; height: 54px;" width="260" >
    <input type="email" name="email"  placeholder="Email" autocomplete="off" class="login-group">
    <br>
    <br>
    <input type="submit" name="submit" value="Reset Password" style="background: grey;">
    <br>
    <br> 
          ...
          <tr>
            <td style="padding-top:0;padding-bottom:0;padding-right:30px;padding-left:30px;text-align:center;Margin-right:auto;Margin-left:auto;">
              <center>
                ...
                <p style="font-family:'Muli',Arial,sans-serif;Margin:0;text-align:center;Margin-right:auto;Margin-left:auto;font-size:15px;color:#a1a8ad;line-height:23px;">or email <a href="mailto:tournamentgeek.com" style="color:#a1a8ad;text-decoration:underline;" target="_blank">tournamentgreek.com</a></p>

                <p style="font-family:'Muli',Arial,sans-serif;Margin:0;text-align:center;Margin-right:auto;Margin-left:auto;padding-top:10px;padding-bottom:0px;font-size:15px;color:#a1a8ad;line-height:23px;">© Tournament Geek.com <span style="white-space: nowrap">​</span>, <span style="white-space: nowrap">Kota,</span> <span style="white-space: nowrap"></span></p>
              </center>
            </td>
          </tr>
          <!-- whitespace -->
